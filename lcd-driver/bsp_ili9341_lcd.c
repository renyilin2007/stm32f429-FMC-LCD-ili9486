...
void ILI9486_REG_Config ()
{
	...
	ILI9341_Write_Cmd(0xC0);
	ILI9341_Write_Data(0x19);//VREG1OUT POSITIVE
	ILI9341_Write_Data(0x1a);//VREG2OUT NEGATIVE
	
	ILI9341_Write_Cmd(0xC1);
	ILI9341_Write_Data(0x45);//VGH,VGL    VGH>=14V.
	ILI9341_Write_Data(0x00);
	...
	ILI9341_Write_Cmd(0XC5);
	ILI9341_Write_Data(0x00);
	ILI9341_Write_Data(0x28);//VCM_REG[7:0]. <=0X80.
		
	ILI9341_Write_Cmd(0xB1);//OSC Freq set.
	ILI9341_Write_Data(0x90);//0xA0=62HZ,0XB0 =70HZ, <=0XB0.
	ILI9341_Write_Data(0x11);
	
	ILI9341_Write_Cmd(0xB4);
	ILI9341_Write_Data(0x02); //2 DOT FRAME MODE,F<=70HZ.
	
	ILI9341_Write_Cmd(0xB6);
	ILI9341_Write_Data(0x00);
	ILI9341_Write_Data(0x42);//0 GS SS SM ISC[3:0];
	...
	ILI9341_Write_Data(0x25);
	ILI9341_Write_Data(0x22);
	ILI9341_Write_Data(0x0B);
	ILI9341_Write_Data(0x06);
	ILI9341_Write_Data(0x0A);
	ILI9341_Write_Data(0x4E);
	ILI9341_Write_Data(0xC6);
	ILI9341_Write_Data(0x39);
	ILI9341_Write_Data(0x00);
	ILI9341_Write_Data(0x00);
	ILI9341_Write_Data(0x00);
	...
	ILI9341_Write_Data(0x0F);
	ILI9341_Write_Data(0x0F);
	ILI9341_Write_Data(0xA4);
	ILI9341_Write_Data(0x02);
	
	ILI9341_Write_Cmd(0XF2);
	ILI9341_Write_Data(0x18);
	ILI9341_Write_Data(0xA3);
	ILI9341_Write_Data(0x12);
	ILI9341_Write_Data(0x02);
	...
	ILI9341_Write_Cmd(0x36);
    ILI9341_Write_Data((1<<3)|(1<<7)|(1<<5));//BGR==1,MY==1,MX==0,MV==1
